...
class OdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oder" do
    assert_difference('Oder.count') do
      post oders_url, params: { oder: { references: @oder.references, total: @oder.total, user: @oder.user } }
    end
  ...
  test "should update oder" do
    patch oder_url(@oder), params: { oder: { references: @oder.references, total: @oder.total, user: @oder.user } }
